...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    public TagView getTagViewByName(String tagName) {
        for (View view : mChildViews) {
            if (view instanceof TagView) {
                TagView tagView = (TagView) view;
                if (tagView.getText().equals(tagName)) {
                    return tagView;
                }
            }
        }
    ...
    public void clearChecked(View exceptTagView) {
        for (View view : mChildViews) {
            if (view instanceof TagView) {
                TagView tagView = (TagView) view;
                if (tagView.isChecked() && tagView != exceptTagView) {
                    tagView.setChecked();
                }
            }
        }
