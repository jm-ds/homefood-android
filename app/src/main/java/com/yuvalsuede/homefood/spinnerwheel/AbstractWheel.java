/*
 * android-com.yuvalsuede.homefood.spinnerwheel
...
package com.yuvalsuede.homefood.spinnerwheel;
...
import com.yuvalsuede.homefood.spinnerwheel.adapters.WheelViewAdapter;

import java.util.LinkedList;
import java.util.List;

/**
 * Abstract spinner com.yuvalsuede.homefood.spinnerwheel view.
...
public abstract class AbstractWheel extends View {
    ...
    /**
     * Scroll the com.yuvalsuede.homefood.spinnerwheel
     *
    ...
    public void scroll(int itemsToScroll, int time) {
        ...
        onScrollTouched(); // we have to emulate touch when scrolling com.yuvalsuede.homefood.spinnerwheel programmatically to light up stuff
        mScroller.scroll(distance, time);
    }

    /**
     * Scrolls the com.yuvalsuede.homefood.spinnerwheel
     *
    ...
    /**
     * Returns base dimension of the com.yuvalsuede.homefood.spinnerwheel — width for horizontal com.yuvalsuede.homefood.spinnerwheel, height for vertical
     *
     * @return width or height of the com.yuvalsuede.homefood.spinnerwheel
     */
    abstract protected int getBaseDimension();

    /**
     * Returns base dimension of base item — width for horizontal com.yuvalsuede.homefood.spinnerwheel, height for vertical
     *
    ...
    /**
     * Processes MotionEvent and returns relevant position — x for horizontal com.yuvalsuede.homefood.spinnerwheel, y for vertical
     *
     ...
     * Actual amount of visible items depends on com.yuvalsuede.homefood.spinnerwheel layout parameters.
    ...
    /**
     * Tests if com.yuvalsuede.homefood.spinnerwheel is cyclic. That means before the 1st item there is shown the last one
     *
     * @return true if com.yuvalsuede.homefood.spinnerwheel is cyclic
     */
    ...
    /**
     * Set com.yuvalsuede.homefood.spinnerwheel cyclic flag
     *
    ...
    /**
     * Adds com.yuvalsuede.homefood.spinnerwheel changing listener
     *
    ...
    /**
     * Removes com.yuvalsuede.homefood.spinnerwheel changing listener
     *
     * @param listener the listener
     */
     ...
     *
     * @param oldValue the old com.yuvalsuede.homefood.spinnerwheel value
     * @param newValue the new com.yuvalsuede.homefood.spinnerwheel value
     */
    ...
    /**
     * Adds com.yuvalsuede.homefood.spinnerwheel scrolling listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Removes com.yuvalsuede.homefood.spinnerwheel scrolling listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Adds com.yuvalsuede.homefood.spinnerwheel clicking listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Removes com.yuvalsuede.homefood.spinnerwheel clicking listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Rebuilds com.yuvalsuede.homefood.spinnerwheel items if necessary. Caches all unused items.
     *
    ...
    /**
     * Calculates range for com.yuvalsuede.homefood.spinnerwheel items
     *
     ...
     *
     * @param index the item index
     * @return true if item index is not out of bounds or the com.yuvalsuede.homefood.spinnerwheel is cyclic
     */
