...
/**
 * Scroller class handles scrolling events and updates the com.yuvalsuede.homefood.spinnerwheel
 */
public abstract class WheelScroller {
    ...
    public WheelScroller(Context context, ScrollingListener listener) {
        gestureDetector = new GestureDetector(context, new SimpleOnGestureListener() {
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                ...
                //  when user touch and move the com.yuvalsuede.homefood.spinnerwheel
                return true;
            }
    ...
    /**
     * Justifies com.yuvalsuede.homefood.spinnerwheel
     */
