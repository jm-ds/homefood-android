...
/**
 * Recycle stored com.yuvalsuede.homefood.spinnerwheel items to reuse.
 */
public class WheelRecycler {
     ...
     * Constructor
     *
     * @param wheel the com.yuvalsuede.homefood.spinnerwheel view
     */
     ...
     * @param range     the range of current com.yuvalsuede.homefood.spinnerwheel items
